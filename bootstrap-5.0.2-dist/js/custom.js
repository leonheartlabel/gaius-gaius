...
// console.log("ghjnrgiouhtiuohnrtuhrtuioherouiherohije")
var w = 0;
$(function(){
    "use strict";
    ...
    $(window).on("scroll", function() {
		if ($(this).scrollTop() > 0){  
	    	...
	    	$('.header a').removeClass("a_menu");
	    	// $('.header .logo-title').addClass(".color-title-hover");
	  	}
	  	else{
	    	$('.header').removeClass("sticky");
            $('.header a').addClass("a_menu");
	    	// $('.header .logo-title').removeClass(".color-title-hover");
	  	}
	});
	/*----- Sticky Header End ----- */
